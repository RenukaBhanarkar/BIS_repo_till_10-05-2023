...
<div class="row">
        <div class="col-12">
            <div class="card border-top card-body">
                <div>
                    <a href="<?php echo base_url(); ?>admin/create_discussion_form" class="btn btn-primary btn-sm mr-2" title="View">Create New Discussion</a>
                    ...
                    <table id="example" class="hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>Reason</td>
                              <td class="d-flex">
                                 <a href="<?php echo base_url(); ?>admin/important_draft_view" class="btn btn-primary btn-sm mr-2" title="View">View</a>
                                 <a href="<?php echo base_url(); ?>admin/important_draft_view" class="btn btn-info btn-sm mr-2" title="View">Edit</a>
                                 <a href="<?php echo base_url(); ?>admin/important_draft_view" class="btn btn-success btn-sm mr-2" title="View">Create</a>
                                 <a href="<?php echo base_url(); ?>admin/important_draft_view" class="btn btn-danger btn-sm mr-2" title="View">Delete</a>
