        ...
        <div class="col-12">
            <div class="card border-top card-body">
                <div>
                    ...
                    <button type="button" class="btn btn-primary btn-sm mr-2" >Archived News</button>
                                                ...
                                                <div class="modal-body">
                                                   <div class="row">
                                                        <div class="mb-2 col-md-4">
                                                            ...
                                                            <input type="text" class="form-control input-font" name="banner_caption" id="banner_caption" placeholder="Enter Title" value="" required>
                                                        </div>
                                                   </div>
                                                   <div class="row">
