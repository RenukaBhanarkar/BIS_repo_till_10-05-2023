                    ...
                    <table id="example" class="hover table-bordered nowrap" style="width:100%">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>Reason</td>
                              <td class="d-flex">
                                 <a href="<?php echo base_url(); ?>" class="btn btn-primary btn-sm mr-2" title="View">View</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-info btn-sm mr-2" title="View">Edit</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-danger btn-sm mr-2" title="View">Delete</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-info btn-sm mr-2" title="View">Sent For Approval</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-primary btn-sm mr-2" title="View">Archive</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-success btn-sm mr-2" title="View">Publish</a>
                                 <a href="<?php echo base_url(); ?>" class="btn btn-warning btn-sm mr-2" title="View">Unpublish</a>
