                        ...
                        <div class="inner-section " id="qustions-tab">
                           <?php // echo  $user_id; ?>
                            ...
                            <div class="d-flex float-end my-4">
                                <button type="button" id="review" class="btn btn-primary" style="margin-right: 838px;"
                                 value="<?= $details['que_id'] ?>" name="mark_for_id[]">Mark For Review</button>
    ...
    <script>
        ...
        $(function() {
            ...
            foreach ($que_details as $key => $details) { ?>
                ...
                $('#quiz_start').on('click', '.nextbtnNew', function(e) {
                    e.preventDefault();
                });
